...
const EditForm = ({ onClose, input }: { onClose: any, input: number }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/providers/${input}`, {
        name: name,
        mobile: mobile,
        email: email,
        user_name: user_name,
      ...
      setMessage('Failed to update service provider. Please try again.');
    }
  };
  ...
  return (
    <Card className='modal1'>
      <Grid container justifyContent="space-between">
        <CardHeader title='Edition for Service Provider' titleTypographyProps={{ variant: 'h6' }} />
