...
const DeleteForm = ({ onClose, input }: { onClose: any, input: number }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/providers/${input}`, {
  ...
  return (
        <Card className='modal1' >
          <CardHeader title='Deletion for a Service Provider' titleTypographyProps={{ variant: 'h6' }}  ></CardHeader>
